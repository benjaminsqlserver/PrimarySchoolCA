...
{
    public partial class AddAssessmentSetup
    {
        [Inject]
        ...
        {
            assessmentSetup = new PrimarySchoolCA.Server.Models.ConData.AssessmentSetup();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await ConDataService.CreateAssessmentSetup(assessmentSetup);
