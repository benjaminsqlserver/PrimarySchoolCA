...
{
    public partial class EditParentsOrGuardian
    {
        [Inject]
        ...
        {
            parentsOrGuardian = await ConDataService.GetParentsOrGuardianByParentOrGuardianId(parentOrGuardianId:ParentOrGuardianID);
            lgDropdownIsDisabled = true;
        }
        ...
        protected bool lgDropdownIsDisabled;
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await ConDataService.UpdateParentsOrGuardian(parentOrGuardianId:ParentOrGuardianID, parentsOrGuardian);
