...
namespace PrimarySchoolCA.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<PrimarySchoolCA.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<PrimarySchoolCA.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(PrimarySchoolCA.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(PrimarySchoolCA.Server.Models.ApplicationUser user)
        {
            try
            {
