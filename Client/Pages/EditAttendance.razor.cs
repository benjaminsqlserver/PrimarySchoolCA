...
namespace PrimarySchoolCA.Client.Pages
{
    public partial class EditAttendance
    {
        ...
        {
            attendance = await ConDataService.GetAttendanceByAttendanceId(attendanceId:AttendanceID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await ConDataService.UpdateAttendance(attendanceId:AttendanceID, attendance);
