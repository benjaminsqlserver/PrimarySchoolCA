...
namespace PrimarySchoolCA.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected IEnumerable<PrimarySchoolCA.Server.Models.ApplicationRole> roles;
        protected RadzenDataGrid<PrimarySchoolCA.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(PrimarySchoolCA.Server.Models.ApplicationRole role)
        {
            try
            {
