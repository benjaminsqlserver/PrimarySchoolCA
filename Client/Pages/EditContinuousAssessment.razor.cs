...
{
    public partial class EditContinuousAssessment
    {
        [Inject]
        ...
        {
            continuousAssessment = await ConDataService.GetContinuousAssessmentByRecordId(recordId:RecordID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await ConDataService.UpdateContinuousAssessment(recordId:RecordID, continuousAssessment);
