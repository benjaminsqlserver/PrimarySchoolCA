...
{
    public partial class AddLocalGovtArea
    {
        [Inject]
        ...
        {
            localGovtArea = new PrimarySchoolCA.Server.Models.ConData.LocalGovtArea();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await ConDataService.CreateLocalGovtArea(localGovtArea);
