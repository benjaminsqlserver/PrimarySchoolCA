...
{
    public partial class EditClassRegister
    {
        [Inject]
        ...
        {
            classRegister = await ConDataService.GetClassRegisterByClassRegisterId(classRegisterId:ClassRegisterID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await ConDataService.UpdateClassRegister(classRegisterId:ClassRegisterID, classRegister);
